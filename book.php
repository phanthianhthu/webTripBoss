                    ...
                    <div class="bookForm">
                        <div class="book1">
                            <div class="inputBox">
                                ...
                                <input type="text" class="form-control name" name="inputName" placeholder="Enter your name" required>
                            </div>
                            <!-- <div class="inputBox">
                            ...
                            <div class="inputBox">
                                ...
                                <input type="phone" class="form-control name" name="inputPhone" placeholder="Enter your number" required>
                            </div>
                            <div class="inputBox">
                                <span class="name-input">Address </span>
                                <input type="text" class="form-control name" name="inputAddr" placeholder="Enter your address" required>
                            </div>
                            <div class="inputBox">
                                <span class="name-input">Where to </span>
                                <input type="text" class="form-control name" name="inputWhereTo" placeholder="Place you want to visit" required>
                            </div>
                        </div>
                        <div class="book2">
                            <div class="inputBox">
                                <span class="name-input">How many </span>
                                <input type="number" class="form-control name" name="inputNumGuest" placeholder="Number of guests" required>
                            </div>
                            <div class="inputBox">
                                <span class="name-input">Arrivals </span>
                                <input type="date" class="form-control name" name="inputArivals" required>
                            </div>
                            <div class="inputBox">
                                <span class="name-input">Leaving </span>
                                <input type="date" class="form-control name" name="inputLeaving" required>
                            </div>
                        </div>
                    </div>
