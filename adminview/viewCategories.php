...
<div >
  ...
  <table class="table ">
    ...
    <tr>
      <td><?=$row["cateName"]?></td>   
      <td><?=$row["cateDesc"]?></td>   
      <td><button class="btn btn-primary" style="height:40px" onclick="cateEditForm('<?=$row['cateId']?>')">Edit</button></td> 
      <td><button class="btn btn-danger" style="height:40px" onclick="categoryDelete('<?=$row['cateId']?>')">Delete</button></td>
      </tr>
      <?php
          }
        }
